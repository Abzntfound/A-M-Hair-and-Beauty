...
const AM_PRODUCTS = [
    ...
    {
        id: 'silk-and-shine',
        name: 'Silk and Shine Bundle',
        subtitle: 'Premium Bundle for the shiniest hair.',
        price: 17.99,
        image: '/Bundle1.jpg',
        images: ['/Bundle1.jpg'],
        category: 'bundles',
        badge: 'New!',
        description: 'Our Bonnet, shampoo and hair oil is sure to rejuvenate your hair back to its former glory!',
        features: [
            '100% natural ingredients',
            'Promotes hair growth and thickness',
            'Nourishes and moisturises the scalp',
    ...
    },
   {
        ...
        category: 'bundles',
        badge: 'New!',
        description: 'Our Head massager and pomade is sure to rejuvenate your hair back to its former glory! Our tumeric soap and handwash will make you feel brand new.',
        features: [
            '100% natural ingredients',
            'Promotes hair growth and thickness',
            'Nourishes and moisturises the scalp',
    ...
    },
   {
        ...
        category: 'bundles',
        badge: 'New!',
        description: 'Our shampoo, conditioner, and pomade will make your hair poof - allowing it to not only look clean but also small like new!',
        features: [
            '100% natural ingredients',
            'Promotes hair growth and thickness',
            'Nourishes and moisturises the scalp',
   ...
   {
        id: 'silk-care-trio',
        name: 'Silky Hair Bundle',
        subtitle: 'Premium Bundle for the silkiesy hair.',
        price: 24.99,
        image: '/Bundle4.jpg',
        images: ['/Bundle4.jpg'],
        category: 'bundles',
        badge: 'New!',
        description: 'Our shampoo and conditioner will cleanse your hair while our hair mist will allow the brush to pass straight through! Perfect for any types of hair.',
        features: [
            '100% natural ingredients',
            'Promotes hair growth and thickness',
            'Nourishes and moisturises the scalp',
   ...
   {
        id: 'complete-blow-dry-kit',
        name: 'Complete Blow Dry Kit',
        subtitle: 'Premium Kit for any types of hair!',
        price: 27.99,
        image: '/Bundle5.jpg',
        images: ['/Bundle5.jpg'],
        category: 'bundles',
        badge: 'New!',
        description: 'This Blow-drying kit will let your hair look brand spanking new with out hand-made pomade and the best shampoo and conditioner!',
        features: [
            '100% natural ingredients',
            'Promotes hair growth and thickness',
            'Nourishes and moisturises the scalp',
    ...
    },
   {
        ...
        category: 'bundles',
        badge: 'New!',
        description: 'Our hair oil and hand-made pomade will leave you feeling the breeze through your roots.',
        features: [
            '100% natural ingredients',
            'Promotes hair growth and thickness',
            'Nourishes and moisturises the scalp',
   ...
   {
        id: 'botanical-growth-duo',
        name: 'Botanical Growth Duo',
        subtitle: 'The best hair growth supplements in all the land.',
        price: 13.99,
        image: '/Bundle7.jpg',
        images: ['/Bundle7.jpg'],
        category: 'bundles',
        badge: 'New!',
        description: "Our hair mist and hair oil will allow you to comb your hair while leaving it clean! You can't ask for more than that!",
        features: [
            '100% natural ingredients',
            'Promotes hair growth and thickness',
            'Nourishes and moisturises the scalp',
   ...
   {
        id: 'complete-care',
        name: 'A&M Complete Care',
        subtitle: 'The full package.',
        price: 64.99,
        image: '/Bundle9.jpg',
        images: ['/Bundle9.jpg'],
        category: 'bundles',
